...
p.circle(l_param,PLSerrrCAL,size=7,color='darkblue',legend="PLS Error CAL")
p.circle(l_param,LWPLSerrCAL,size=7,color='red',legend="LWPLS Error CAL")
show(p)
...
output_file("LocParam"+rnd_num+".html",title='LocParam')
p = figure(tools=TOOLS, tooltips=TOOLTIPS,plot_width=600, plot_height=600, title="Obs vs Pred")
p.circle(l_param,PLSerrrVAL,size=7,color='darkblue',legend="PLS Error VAL")
p.circle(l_param,LWPLSerrVAL,size=7,color='red',legend="LWPLS Error VAL")
show(p)
