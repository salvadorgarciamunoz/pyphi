...
p.scatter(l_param,PLSerrrCAL,size=7,color='darkblue',legend_label="PLS Error CAL")
p.scatter(l_param,LWPLSerrCAL,size=7,color='red',legend_label="LWPLS Error CAL")
...
output_file("LocParam"+rnd_num+".html",title='LocParam')
p = figure(tools=TOOLS, tooltips=TOOLTIPS,width=600, height=600, title="Obs vs Pred")
p.scatter(l_param,PLSerrrVAL,size=7,color='darkblue',legend_label="PLS Error VAL")
p.scatter(l_param,LWPLSerrVAL,size=7,color='red',legend_label="LWPLS Error VAL")
p.xaxis.axis_label = 'Localization Parameter'
p.yaxis.axis_label = 'RMSE'
show(p)
